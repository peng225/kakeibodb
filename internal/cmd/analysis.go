...
func init() {
	...
	analysisCmd.PersistentFlags().String("from", "2018-01-01", "the beginning of time range (inclusive edge)")
	analysisCmd.PersistentFlags().String("to", "2100-12-31", "the end of time range (exclusive edge)")
}
